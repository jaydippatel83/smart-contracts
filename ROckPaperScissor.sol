...
contract RockPaperScissors{
    ...
    function joinGame(uint _gameId) external payable{
        ...
        require(game.state == State.JOINED, "MUst be in created store");
    ...
    function commitMove(uint _gameId, uint moveId, uint salt) external{
        ...
        require(moves[_gameId][msg.sender].hash != 0 ,"move alredy made");
        require(moveId == 0 || moveId == 1 || moveId == 3, "move must be either 1,2 or 3");
